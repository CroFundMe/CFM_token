...
CroFundMe is a crypto fundraising platform. We provide tools to connect people in need with crypto philanthropists.
...
//address
    ...
    address public _MarketingWalletAddress = 0x895969B0C6211d093a61efE22CbaeC7F99f72b07;
    address public _PoolCharityWalletAddress = 0xE7349344030358407A9402c5e2815Ff1536c1f4F;
    address public _DevelopmentWalletAddress = 0x5c454F019d08E3105f3f3593eE86947D5749768c;
...
//uint
    ...
    uint public buyPoolCharityFee = 3;
    uint public sellPoolCharityFee = 3;
    uint public buyDevelopmentFee = 3;
    uint public sellDevelopmentFee = 3;
    uint public buyBusinessFee = buyMarketingFee + buyPoolCharityFee + buyDevelopmentFee;
    uint public sellBusinessFee = sellMarketingFee + sellPoolCharityFee + sellDevelopmentFee;
    ...
    uint public minimumTokensBeforeSwap = 1000 * (10**9); 
    ...
    uint private _OldPoolCharityFee;
...
// constructor
    constructor() {
        ...
        excludedFromFees[_PoolCharityWalletAddress] = true;
    ...
    function isExcludedFromCharity(address account) public view returns (bool) {
        return _isExcluded[account];
    }

    function totalReflectionCharity() public view returns (uint256) {
        return _tReflectionCharityTotal;
    }
    ...
    function excludeFromCharity(address account) public onlyOwner() {
    ...
    function includeInCharity(address account) external onlyOwner() {
    ...
    function setFees() private {
		...
		sellBusinessFee = sellMarketingFee + sellPoolCharityFee + sellDevelopmentFee;
    ...
    function setPoolCharityFee(uint buy, uint sell) external onlyOwner() {
        buyPoolCharityFee = buy;
        sellPoolCharityFee = sell;
        setFees();
    }
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        _tReflectionCharityTotal = _tReflectionCharityTotal.add(tFee);
    }
    ...
    function sendToWallet(uint amount) private {
        ...
        uint256 poolcharity_part = amount * sellPoolCharityFee / 100;
        ...
        (bool success2, ) = payable(_PoolCharityWalletAddress).call{value: poolcharity_part, gas: 30000}("");
...
//set functions
    ...
    function setpoolcharityAddress(address _value) external onlyOwner {
        _PoolCharityWalletAddress = _value;
    }
